...
public class AutenticarConGoogleSoloActivity extends AppCompatActivity {
    ...
    private void trasIntentarRegistrarseEnGoogle(Intent data) {
        ...
        try {
            ...
            GoogleSignInAccount micuentaGoogleSignInAccount = task.getResult(ApiException.class);
