...
public class VariosARLActivity extends AppCompatActivity {

    EditText etEnviar;
    ImageView ivFoto;
    VariosARLActivity contexto;
            ...
            miARL_hacerFoto = registerForActivityResult(
                    ...
                    new ActivityResultCallback<Boolean>() {
                        ...
                        public void onActivityResult(Boolean result) {
                            ...
                            try {
                                Bitmap bitmap = MediaStore.Images.Media.getBitmap(VariosARLActivity.this.getContentResolver(), uriDeFicheroResultante);
    ...
    public void lanzarActividadEsperandoRespuesta() {
        ...
        Intent intentHaciaSecondActivity = new Intent(VariosARLActivity.this, SecondActivity.class);
        ...
        miARL_buscarImagenes = registerForActivityResult(
                ...
                new ActivityResultCallback<Uri>() {
                    ...
                    public void onActivityResult(Uri uri) {
                        try {
                            Bitmap bitmap = MediaStore.Images.Media.getBitmap(VariosARLActivity.this.getContentResolver(), uri);
                            ivFoto.setImageBitmap(bitmap);
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
