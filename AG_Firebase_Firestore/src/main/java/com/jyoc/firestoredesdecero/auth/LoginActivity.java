package com.jyoc.firestoredesdecero.auth;
...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void intentarObtenerCuentaGoogle() {
        ...
        if (micuenta != null) {
            ...
            Toast.makeText(getApplicationContext(), "Bienvenido "+micuenta.getDisplayName(), Toast.LENGTH_LONG).show();
            // hacer lo que sea con el nombre del usuario, seguir adelante, Y ABRIR LA ACTIVIDAD INICIAL
            //Uri uri;
            Intent intent = new Intent(this, MainActivity.class);
            intent.putExtra("MICUENTAGOOGLE", micuenta);

//            intent.putExtra("ID_GOOGLE", micuenta.getId());
//            intent.putExtra("USUARIO_GOOGLE", micuenta.getDisplayName());
           intent.putExtra("MAIL_GOOGLE", micuenta.getEmail());
        ...
        firebaseAuth.signInWithCredential(credential).addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                if (task.isSuccessful()) {
                    ...
                    // Abrir la actividad inicial
                    Intent intent = new Intent(LoginActivity.this, MainActivity.class);
                    intent.putExtra("ID_GOOGLE", user.getUid());
                    intent.putExtra("USUARIO_GOOGLE", user.getDisplayName());
                    intent.putExtra("MAIL_GOOGLE", user.getEmail());
