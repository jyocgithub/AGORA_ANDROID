...
public class JGA_08_ServicioActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // **************************************************
        //  RECORDAR REGISTRAR LOS SERVICIOS EN EL MANIFIESTO
        // ***************************************************
        // <application
        //  …
        //   <service
        ...
        // Si solo se va a usar un hilo dentro del servicio, 
        // o se desea que las sucesivas llamadas se ejecuten 
        // de modo encadenado (una tras otra) y no concurrentemente, 
        // entonces es más práctico usar IntentService, 
        // que se caracteriza por:
        // - Crea automáticamente un hilo, 
        //   no hace falta que lo cree el usuario.
        // - Cada vez que se “inicia” el IntentService se encola, 
        //   y no se ejecuta hasta que se hayan terminado 
        //   de ejecutar las anteriores “llamadas”
        // - El servicio se termina cuando se termina la ejecución de su contenido, 
        //   no es necesario que explícitamente se llame a stopSelf() o stopService()
        //   Cuando se termina el servicio, se destruye igualmente el hilo 
        ...
        // Un servicio en primer plano realiza una operación que el 
        // usuario puede notar. 
        // Por ejemplo, una aplicación de audio usa un servicio en primer 
        // plano para reproducir una pista de audio. 
...
class ServicioPrimerPlano extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        Intent intentConNotificacion = new Intent(this, JGA_08_ServicioActivity.class);
