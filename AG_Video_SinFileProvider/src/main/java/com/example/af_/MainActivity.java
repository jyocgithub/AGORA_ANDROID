...
public class MainActivity extends AppCompatActivity {
    ...
    public void accionesConPermisos() {
        ...
        ((Button) findViewById(R.id.btComenzar2)).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                
               //startActivity(new Intent(MainActivity.this, VideoSinCamara.class));
               //startActivity(new Intent(MainActivity.this, PlayVideoSurfaceViewActivity.class));
               startActivity(new Intent(MainActivity.this, RecordVideoSurfaceView.class));
            }
        });
    }
    ...
    private void grabarVideo() {
        ...
        File directorioEnDCIM = new File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DCIM), "misvideos");
