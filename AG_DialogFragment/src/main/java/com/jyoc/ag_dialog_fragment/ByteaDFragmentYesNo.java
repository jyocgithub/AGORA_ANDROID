...
/*
    // EJEMPLO DE USO
    // ==========================================================================================
     public void lanzarPregunta(String titulo, String mensaje, String texto_ok, String texto_ko,int position){
        // CREAR DIALOGO
        ByteaDFragmentYesNo dialog = ByteaDFragmentYesNo.newInstance(titulo, mensaje, texto_ok, texto_ko );
        // LISTENERS
...
public class ByteaDFragmentYesNo extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        buttonParams.setMargins(0, margin, 0, 0); // Sólo margen arriba
