...
public class MiClaseSqlite extends SQLiteOpenHelper {
    ...
    private SQLiteDatabase objetoBBDD;
    ...
    public MiClaseSqlite(Context contexto) {
    ...
    public void guardarJugador(Jugador j) {
        ...
        Object[] parametrosdelsql = new Object[3];
    ...
    public void borrarJugador(int idjugadoraborrar) {
        ...
        Object[] parametrosdelsql = new Object[1];
    ...
    public void actualizarJugador(Jugador j) {
        ...
        Object[] parametrosdelsql = new Object[2];
    ...
    public ArrayList<Jugador> leerJugadoresPorPuntos(int puntosminimos) {
        ...
        // Ejemplo con cursor sin parametros;
        String sql = "SELECT idJugador, nombre, puntos FROM JugadoresDB where puntos > ?";

        String[] parametrosdelsql = new String[1];
        parametrosdelsql[0] = puntosminimos + "";
      
        Cursor c = objetoBBDD.rawQuery(sql, parametrosdelsql);
    ...
    public void copiaDeSeguridadBBDDActualTodosLosRegistros() {
        ...
        String sql2 = "INSERT INTO JugadoresDBCopia (idJugador , nombre , puntos )  " +
                "SELECT idJugador , nombre , puntos  FROM JugadoresDB";
    ...
    public void borrarRegistroYGuardarloAntesEnHistorico(int idjugadoraborrar) {
        ...
        String sql2 = "INSERT INTO JugadoresDBHistorico (idJugador , nombre , puntos )  " +
                "SELECT idJugador , nombre , puntos " +
